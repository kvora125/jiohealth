    ...
    return (
      <div>
        ...
        <div className="App-header-small">
         <Button onClick={()=>{setDrawerVisible(true);}}><MenuOutlined style={{ fontSize: '25px', color: '#08c', background:'none' }} /></Button><img style={{display:'inline'}} src={logo} className="App-logo-small" alt="logo" /><label style={{fontSize:'40px' ,color:'black', marginTop:'50px'}}>Jio</label><label style={{fontSize:'40px' ,color:'white', marginTop:'20px'}}> Health +</label>  <Button onClick={()=>setLogIn(false)} style={{float:'right', margin:'20px'}}>LOGOUT</Button>
        </div>
